                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
							...
							<a class="nav-link" href="./admin_vistas/citas_clientes.php"><div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>Citas</a>		
							<a class="nav-link" href="./admin_vistas/reportes.php"><div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>Reportes</a>
										
						    <?php }else{?>
                                 <a class="nav-link" href="./admin_vistas/reportes.php"><div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>Mi información</a>
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- inicio -->
                                ...
                                <?php if($tipo_usuario==2) {?>
                                  <h1 class="mt-4 ml-4 text-center">Reserva de citas</h1>
                                  <hr>
